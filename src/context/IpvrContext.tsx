...
const STORAGE_KEYS = {
  ORG: 'sgsst_ipvr_org_v5_master_pec',
  RECORDS: 'sgsst_ipvr_records_v5_master_pec',
  ACTIONS: 'sgsst_ipvr_actions_v5_master_pec',
  CATALOGS: 'sgsst_ipvr_catalogs_v5_master_pec',
  CUSTOM_HAZARDS: 'sgsst_ipvr_custom_hazards_v5_master_pec'
};
